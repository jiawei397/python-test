...
# 安装scrapy，需要先安装Twisted
# https://download.lfd.uci.edu/pythonlibs/n5jyqt7p/Twisted-19.2.1-cp37-cp37m-win_amd64.whl
...
if __name__ == '__main__':
    ...
    for html in total_url_list:
        ...
        for url in urls:
            ...
            base_dir = "{1}/{0}/".format(map_title_url.get(url), dir)
