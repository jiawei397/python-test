...
# 词云形状图片
WC_MASK_IMG = '../resources/wawa.jpg'
# WC_MASK_IMG = 'test.png'
# 评论数据保存文件
COMMENT_FILE_PATH = '../resources/jd_comment.txt'
# 词云字体
...
def spider_comment(page=0):
    ...
    """
    url = 'https://search.jd.com/Search?keyword=笔记本&enc=utf-8&qrst=1&rt=1&stop=1&vt=2&wq=tysg&page=%s&s=57&click=0' % page
